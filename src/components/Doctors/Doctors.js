...
const doctors = [
    ...
    {
        name: 'Костишин Лілія', position: 'отоларинголог', exp: '', info: 'дитячий та дорослий отоларинголог',
        img: 'kostyshyn.jpg'
    },
    {
        name: 'Шарков Олександр', position: 'масажист', exp: '', info: '',
        img: 'sharkov.jpg'
    },
    {
        name: 'Коломієць Анастасія', position: 'фізичний терапевт, реабілітолог, кінезіотерапевт', exp: '5 років', info: '',
        img: 'kolomiiets.jpg'
    },
    {
