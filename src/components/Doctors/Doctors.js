...
const doctors = [
    ...
    {
        name: 'Зигар Анастасія', position: 'терапевт', exp: 'понад 7 років', info: 'Працює за принципами доказової медицини та без зайвих призначень. Допомогає при:\n▫️ підвищеному або нестабільному тиску\n▫️ порушенні рівня цукру\n▫️ частих застудах та інфекціях\n▫️ проблемах з ШКТ та загальному погіршенні самопочуття',
        img: 'zyhar.jpg'
    },
    {
    ...
    {
        name: 'Коржакова Олександра', position: 'дерматовенеролог, трихолог', exp: '3 роки', info: 'Лікар із сучасним підходом до дерматології, який поєднує знання доказової медицини, естетики та комплексного бачення здоров’я пацієнта. Має 3 роки практичного досвіду та освіту, здобуту в провідних медичних закладах України: БДМУ, НМУ ім. Богомольця та НМАПО ім. Шупика.',
        img: 'korzhakova.jpg'
    },
    {
    ...
    {
        name: 'Савіцька Аліна', position: 'дерматолог, косметолог', exp: '', info: '',
        img: 'savytska.jpg'
    },
    {
        name: 'Гаврилюк Наталія', position: 'медична сестра, масажист', exp: '', info: 'Спеціаліст, який поєднує медичні знання та практичні навички масажу для комплексного відновлення організму. У своїй роботі вона орієнтується не лише на усунення симптомів, а й на пошук та опрацювання причин дискомфорту.',
        img: 'havryliuk.jpg'
    },
]
